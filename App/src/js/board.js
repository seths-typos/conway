   ...
   */
      this.canvas: {
        ...
        init : function() {
          ...
          // this.helpers.registerEvent(this.canvas, 'mousedown', this.handlers.canvasMouseDown, false);
          // this.helpers.registerEvent(document, 'mouseup', this.handlers.canvasMouseUp, false);
          // this.helpers.registerEvent(this.canvas, 'mousemove', this.handlers.canvasMouseMove, false);
