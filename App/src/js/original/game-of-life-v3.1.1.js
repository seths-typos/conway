 ...
 */
   ...
   */
     ...
     * Register Event
     */
    static _registerEvent (element, event, handler, capture) {
 ...
 * Init on 'load' event
 */
GOL._registerEvent(window, 'load', function () {
  var GAME = new GOL({});
  GAME.init();

  // this.constructor._registerEvent(document.getElementById('buttonRun'), 'click', this.buttonRun, false);
  // this.constructor._registerEvent(document.getElementById('buttonStep'), 'click', this.buttonStep, false);
  // this.constructor._registerEvent(document.getElementById('buttonClear'), 'click', this.buttonClear, false);
